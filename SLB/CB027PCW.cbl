       ...
       01  CB027PE AUTO.
           05 CTAC-FORMATO
              LINE 07 COLUMN 16 PIC X(008) USING CBFOHI-FORMATO.

       01  CB027PB AUTO.
           05 CTAC-COMENTARIO
              LINE 08 COLUMN 16 PIC X(050) USING CBFOHI-COMENTARIO.
           05 CTAC-I-01 LINE 12 COLUMN 18 PIC Z(003) USING CBFOHI-I(01).
           05 CTAC-F-01 LINE 12 COLUMN 22 PIC Z(003) USING CBFOHI-F(01).
           05 CTAC-I-02 LINE 13 COLUMN 18 PIC Z(003) USING CBFOHI-I(02).
           05 CTAC-F-02 LINE 13 COLUMN 22 PIC Z(003) USING CBFOHI-F(02).
           05 CTAC-I-03 LINE 14 COLUMN 18 PIC Z(003) USING CBFOHI-I(03).
           05 CTAC-F-03 LINE 14 COLUMN 22 PIC Z(003) USING CBFOHI-F(03).
       ...
       100-PROCESSAMENTO.
           ...
           IF   NOT FINALIZAR
                ...
                OR   VEZ = 2
                     MOVE 3 TO VEZ
                     INITIALIZE CBFOHI-REG
                END-IF
                PERFORM 170-EXIBE-DADOS THRU 170-99-FIM
                PERFORM 140-LER-CBFOHI  THRU 140-99-FIM
                        UNTIL FS-CBFOHI = "00"
                        OR    FL-EXIT = 1
       ...
       130-CRITICA.
           ...
           PERFORM TEST AFTER UNTIL (F2 AND  ERRO = 0)
                   ...
                   AND > 0
                      ...
                      MOVE CBFOHI-I (I) TO Y
                      PERFORM CBFOHI-F (I) TIMES
                              MOVE "²"  TO MAPA (Y: 1)
                              ADD 1 TO Y
                      END-PERFORM
                      DISPLAY CB027P-MAPA
       ...
       140-LER-CBFOHI.
           ...
           IF   FL-EXIT NOT = 1
                ...
                AND  OK = ZERO
                     MOVE 1     TO OK
                     START CBFOHI  KEY NOT < CBFOHI-CHAVE
                END-IF
                IF  (PAGE-UP OR PAGE-DOWN)
                AND  NOT INCLUSAO
                     IF   PAGE-DOWN
                     ...
                     IF   FS-CBFOHI < "10"
                          PERFORM 170-EXIBE-DADOS THRU 170-99-FIM
                          GO TO 140-LER-CBFOHI
                     ELSE
                          MOVE ZERO TO OK
                          MOVE "44" TO FS-CBFOHI
                     END-IF
                ELSE
                     IF   CBFOHI-FORMATO = SPACES
       ...
       175-EXIBE-MAPA.
           ...
           PERFORM VARYING C FROM 1 BY 1 UNTIL C > 2
                   IF   CBFOHI-I (C) NOT = 0
                        MOVE CBFOHI-I (C) TO Y
                        PERFORM CBFOHI-F (C) TIMES
                                MOVE C (3: 1)
                                  TO MAPA (Y: 1)
                                ADD 1 TO Y
                        END-PERFORM
